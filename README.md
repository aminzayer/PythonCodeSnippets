# Python Code Snippets: Your Ultimate Guide
...
4. [Defining a Function](#defining-a-function)
5. [Using Lists](#using-lists)
6. [Using Dictionaries](#using-dictionaries)
7. [`while` Loop](#while-loop)
8. [Using Standard Modules](#using-standard-modules)
9. [List Comprehension](#list-comprehension)
10. [Exception Handling](#exception-handling)
11. [Working with Strings](#working-with-strings)
12. [Using Sets](#using-sets)
13. [Using Tuples](#using-tuples)
14. [Getting User Input](#getting-user-input)
15. [Converting Data Types](#converting-data-types)
16. [Finding the Length of a List](#finding-the-length-of-a-list)
17. [Sorting a List](#sorting-a-list)
18. [Appending to a List](#appending-to-a-list)
19. [Removing an Item from a List](#removing-an-item-from-a-list)
20. [Checking Membership in a List](#checking-membership-in-a-list)
21. [Creating a Dictionary](#creating-a-dictionary)
22. [Accessing Dictionary Values](#accessing-dictionary-values)
23. [Updating Dictionary Values](#updating-dictionary-values)
24. [Deleting Dictionary Items](#deleting-dictionary-items)
25. [Checking Dictionary Keys](#checking-dictionary-keys)
26. [Using `enumerate` with Lists](#using-enumerate-with-lists)
27. [Using `zip` to Combine Lists](#using-zip-to-combine-lists)
28. [Creating a Function with Default Arguments](#creating-a-function-with-default-arguments)
29. [Using the `range` Function](#using-the-range-function)
30. [String Formatting with `f-strings`](#string-formatting-with-f-strings)
31. [Using the `in` Operator with Strings](#using-the-in-operator-with-strings)
32. [Checking for `None`](#checking-for-none)
33. [Creating and Using Classes](#creating-and-using-classes)
34. [Working with Dates and Times](#working-with-dates-and-times)
35. [Using `map` to Apply a Function to a List](#using-map-to-apply-a-function-to-a-list)
36. [Using `filter` to Filter a List](#using-filter-to-filter-a-list)
37. [Creating a List of Unique Values](#creating-a-list-of-unique-values)
38. [Handling Keyboard Interrupt (Ctrl+C)](#handling-keyboard-interrupt-ctrlc)
39. [Working with JSON Data](#working-with-json-data)
40. [Using `itertools` for Iteration](#using-itertools-for-iteration)
41. [Creating a Virtual Environment](#creating-a-virtual-environment)
42. [Activating a Virtual Environment](#activating-a-virtual-environment)
43. [Installing Packages with `pip`](#installing-packages-with-pip)
44. [Using a `try`...`except` Block with File Operations](#using-a-tryexcept-block-with-file-operations)
45. [Working with Command-Line Arguments](#working-with-command-line-arguments)
46. [Using `defaultdict` for Default Values in Dictionaries](#using-defaultdict-for-default-values-in-dictionaries)
47. [Reading CSV Files with `csv` Module](#reading-csv-files-with-csv-module)
48. [Using Regular Expressions](#using-regular-expressions)
49. [Creating and Using Generators](#creating-and-using-generators)
50. [Using `os` Module for File Operations](#using-os-module-for-file-operations)
